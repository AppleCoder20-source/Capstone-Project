...
export default function SettingsPage() {
    ...
    const handleDelete = async () => {
        try {
            const response = await axios.delete(`https://capstone-project-8kjr.onrender.com/update/clear/${name}`);
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.patch(`https://capstone-project-8kjr.onrender.com/api/update`, {
                email: newEmail,
